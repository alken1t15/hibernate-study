...
public class Test {
    public static void main(String[] args) {
        ...
        try {
//            session = factory.getCurrentSession();           // Добавление ребенка
...
//            session = factory.getCurrentSession();                              // Получение информации по Сексции
//
//
//            session.beginTransaction();
//
...
//            session = factory.getCurrentSession();                              // Получение информации по Ребенку
//
//
//            session.beginTransaction();
//
...
//            session.getTransaction().commit();
// **************************************************************************************************
//            session = factory.getCurrentSession();                              // Удаление секции
//
//
//            session.beginTransaction();
//
...
//            session.getTransaction().commit();
            // **************************************************************************************************
//            session = factory.getCurrentSession();           // Добавление Удаление
//
//            session.beginTransaction();
